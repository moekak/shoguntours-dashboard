...
function ManualTourEntryModal() {
      ...
      const {openModal, setOpenModal, modalErrors, modalErrorTitle, errorFields} = useCommonContext()
      ...
      const {mutate, isPending} = usePostMutation(API_ENDPOINTS.API.CREATE_EXTERNAL_TOURS, onSuccess, true)
                  ...
                  <Box sx={modalStyle}>
                        ...
                        <div className="bg-white p-6 border-b border-gray-200 flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-[#ecf3ff] rounded-lg flex items-center justify-center">
                                          <InfoOutlinedIcon sx={{ color: "#465fff", fontSize: 24 }} />
                                    </div>
                        ...
                        <div className="overflow-y-auto flex-1 p-6">
                              ...
                              <div className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                          <div>
                                                <Label required={true} error={errorFields?.has("service_provider")}>Service Provider</Label>
                                                <Select
                        ...
                        <div className="bg-gray-50 p-6 border-t border-gray-200 flex justify-end gap-3">
                              ...
                              >
                                    ...
                                    <i className={`fas fa-sync-alt text-sm transition-transform duration-500 ${isPending ? 'animate-spin' : ''}`}></i>
                              </button>
                        </div>
                  </Box>
            </Modal>
