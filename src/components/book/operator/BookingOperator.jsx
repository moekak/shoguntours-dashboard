...
function BookingOperator() {
      ...
      const {errorFields, errors, errorTitle, setOpenModal, successMessage, isSuccess} = useCommonContext()
                                          ...
                                          <div className="mt-4 grid md:grid-cols-2 lg:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                      ...
                                                      <Select
                                                            ...
                                                            className="dark:bg-dark-900"
                                                            onChange={(value) => {
                                                                  handleChange("itinerary_id", value)
                                                            }}
                                                      ...
                                                      <DatePicker
                                                            ...
                                                            onChange={(dates) => {
                                                                  ...
                                                                  if (!isNaN(validDate.getTime())) {
                                                                        handleChange("tour_date", validDate);
                                                                  }
                                                            }}
                                          ...
                                          <div className="mt-6">
                                                <div>
                                                      ...
                                                      <TextArea
                                                            ...
                                                            onChange={(value)=> handleChange("request", value)}
