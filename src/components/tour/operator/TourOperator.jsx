                    ...
                    <div className="mb-8 sticky">
                        ...
                        <p className="text-gray-600 my-2">
                            {type == 'create'
                                ...
                                : 'Edit and update your tour experience details below'}
                        </p>
                        {errors?.length > 0 && (
                            <Alert
                                variant="error"
                            ...
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        type="text"
                                        id="inputToutTitle"
                                        placeholder="e.g., Tokyo City Highlights Tour"
