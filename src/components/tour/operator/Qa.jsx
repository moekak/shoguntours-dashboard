    ...
    return (
        <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
                Add common questions and answers that help customers understand
                the experience.
            </p>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-2">
                                    <TextArea
                                        rows={2}
                                        value={
                                            tour.questions[index]?.answer || ''
                                        }
                                        name={`questions[${index}][answer]`}
                                        onChange={(value) =>
                                            handleInput(value, index, 'answer')
                                        }
                                        error={errorFields?.has(
