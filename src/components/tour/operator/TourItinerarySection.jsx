                        ...
                        <div className="bg-white rounded-xl shadow-sm p-6 relative">
                            <div className="absolute top-6 right-6">
                                <button
                                    type="button"
                                    onClick={() =>
                                        removeItinerary(itineraryIndex)
                                    }
                                ...
                                <div className="m-8 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div>
                                        <Label
                                            ...
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.duration`
                                            )}
                                            htmlFor="inputItineraryDuration"
                                        >
                                            Duration (hours)
                                        </Label>
                                        <Input
                                            ...
                                            value={
                                                tour.itinerary[itineraryIndex]
                                                    .duration
                                            }
                                            type="number"
                                            id="inputItineraryDuration"
                                            placeholder="e.g., 8"
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.duration`}
                                        />
                                    </div>
                                    <div>
                                        <Label
                                            required={true}
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.max_participants`
                                            )}
                                        ...
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.max_participants`}
                                        />
                                    </div>
                                    <div>
                                        <Label
                                            required={true}
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.tour_type`
                                            )}
                                        >
                                            Tour Type
                                        </Label>
                                        ...
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.tour_type`}
                                        />
                                    </div>
                                    <div>
                                        <Label
                                            required={true}
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.meeting_point`
                                            )}
                                        ...
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.meeting_point`}
                                        />
                                    </div>
                                    <div>
                                        <Label
                                            required={true}
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.adult_price`
                                            )}
                                            htmlFor="adult_price"
                                        >
                                            Adult Price (¥)
                                        ...
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.adult_price`}
                                        />
                                    </div>
                                    <div>
                                        <Label htmlFor="child_price">
                                            Child Price (¥)
                                        </Label>
                                        <Input
                                            onChange={(e) =>
                                    ...
                                    <div>
                                        <Label
                                            required={true}
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.logistics_fee`
                                            )}
                                        ...
                                        />
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.logistics_fee`}
                                        />
                                    </div>
                                    <div>
                                        <Label
                                            htmlFor="language"
                                            error={errorFields?.has(
                                                `itinerary.${itineraryIndex}.languages`
                                            )}
                                            required={true}
                                        >
                                            Languages Available
                                            ...
                                            {languages?.map(
                                                (language, index) => (
                                                    <div
                                                        ...
                                                        key={`language-${itineraryIndex}-${index}`}
                                                    >
                                                        <Checkbox
                                                            checked={tour?.itinerary[
                                                                itineraryIndex
                                                            ]?.languages?.includes(
                                                                language.id
                                                            )}
                                        ...
                                        <ErrorMessage
                                            type={`itinerary.${itineraryIndex}.languages`}
                                        />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="p-8">
                                        <div className="space-y-5">
                                            <div>
                                                <Label
                                                    error={errorFields?.has(
                                                        `itinerary.${itineraryIndex}.overview_title`
                                                    )}
                                                ...
                                                />
                                                <ErrorMessage
                                                    type={`itinerary.${itineraryIndex}.overview_title`}
                                                />
                                            </div>
                                            <div>
                                                <Label
                                                    error={errorFields?.has(
                                                        `itinerary.${itineraryIndex}.overview_description`
                                                    )}
                                                >
                                                ...
                                                />
                                                <ErrorMessage
                                                    type={`itinerary.${itineraryIndex}.overview_description`}
                                                />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="border border-gray-200 rounded-lg overflow-hidden mt-8">
                                ...
                                <div className="m-8 space-y-2">
                                    {itinerary.itinerary_highlight.map(
                                        (_, highlightIndex) => (
                                            <HighlightItem
