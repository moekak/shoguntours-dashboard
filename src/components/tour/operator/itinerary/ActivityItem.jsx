        ...
        <div className="activity-item">
            <div className="bg-gray-50 rounded-lg p-3">
                <div className="flex items-start gap-3">
                    <IconSelector
                        selectedIcon={
                            tour.itinerary[itineraryIndex].activity[
                                activityIndex
                            ].activity_icon
                        }
                        ...
                        <div>
                            <Input
                                error={errorFields?.has(
                                    `itinerary.${itineraryIndex}.activity.${activityIndex}.activity_title`
                                )}
                                onChange={(e) =>
                                    handleInput(
                                        e.target.value,
                            ...
                            />
                            <ErrorMessage
                                type={`itinerary.${itineraryIndex}.activity.${activityIndex}.activity_title`}
                            />
                        </div>
                        <div>
                            <TextArea
                                error={errorFields?.has(
                                    `itinerary.${itineraryIndex}.activity.${activityIndex}.activity_description`
                                )}
                                onChange={(value) =>
                                    handleInput(
                                        value,
                            ...
                            />
                            <ErrorMessage
                                type={`itinerary.${itineraryIndex}.activity.${activityIndex}.activity_description`}
                            />
                        </div>
                    </div>
                    <button
                        type="button"
                        onClick={() =>
                            removeActivity(itineraryIndex, activityIndex)
                        }
