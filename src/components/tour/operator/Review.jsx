                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <Select
                                    defaultValue={
                                        tour.reviews?.[index].rating
                                            ? Number(tour.reviews[index].rating)
                                            : ''
                                    }
                                    ...
                                    onChange={(value) =>
                                        handleInput(value, index, 'rating')
                                    }
                                    error={errorFields?.has(
                                        `reviews.${index}.rating`
                                    )}
                        ...
                        <div className="mb-4">
                            ...
                            <TextArea
                                ...
                                onChange={(value) =>
                                    handleInput(value, index, 'content')
                                }
                                rows={3}
                                id="review_content"
