...
const TourEdit = () => {
    const { tour, setTour, setLanguages, setRegions, setCategories } =
        ...
        setTour({
            ...
            itinerary: tour?.itineraries?.map((itinerary) => {
                return {
                    ...
                    activity: itinerary?.itinerary_activities.map(
                        (activity) => {
                            return {
                    ...
                    itinerary_highlight: itinerary?.itinerary_highlights.map(
                        (highlight) => {
                            return highlight?.itinerary_highlight;
                        }
                    ),
                    languages: itinerary?.itinerary_languages.map(
                        (language) => {
