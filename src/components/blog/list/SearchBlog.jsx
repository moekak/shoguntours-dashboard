...
function SearchBlog({blogCategories}) {
      const {searchTerm, setSearchTerm,selectedCategory, setSelectedCategory, filter, selectedStatus, setSelectedStatus} = useBlogsContext()
                              ...
                              <div className="flex flex-col sm:flex-row gap-2">
                                    ...
                                    >
                                          ...
                                          {blogCategories?.map((category, index)=>(
                                                <option key={`category-${category.id}-${index}`} value={category.id}>{category.category_name}</option>
                                          ))}
                                    </select>
                              </div>
