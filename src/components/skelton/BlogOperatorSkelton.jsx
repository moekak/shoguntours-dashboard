    ...
    <Box sx={{ bgcolor: '#f5f5f5', minHeight: '100vh' }}>
      <Box component="main" sx={{ pb: 10 }}>
        <Box sx={{ maxWidth: 1200, mx: 'auto', px: 3 }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Card sx={{ borderRadius: 3, boxShadow: 1 }}>
              <CardContent sx={{ p: 3 }}>
                ...
                {/* Toolbar */}
                <Box sx={{ bgcolor: '#f5f5f5', p: 2, borderRadius: '8px 8px 0 0', border: '1px solid #e0e0e0', display: 'flex', gap: 1.5, mb: 0 }}>
                ...
                {/* Editor */}
                <Skeleton variant="rectangular" width="100%" height={600} sx={{ borderRadius: '0 0 8px 8px', border: '1px solid #e0e0e0', borderTop: 0 }} />
              </CardContent>
            </Card>
          ...
          {/* Fixed Button */}
          <Skeleton variant="circular" width={56} height={56} sx={{ position: 'fixed', bottom: 24, right: 24, zIndex: 50 }} />
        </Box>
      </Box>
    </Box>
  );
