                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`${isLoading ? 'opacity-50 cursor-not-allowed' : 'opacity-100 cursor-pointer'} flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600`}
                                    >
                                        {isLoading ? (
                                            <>
                                                <svg
