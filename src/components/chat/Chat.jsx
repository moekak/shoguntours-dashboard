                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-gray-600 truncate">
                                    Perfect! Let's meet at the coffee shop
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div className="flex justify-center">
                            <span className="px-4 py-2 bg-white rounded-full text-xs text-gray-500 border border-gray-200">
                                Today
                            </span>
                        </div>
                                ...
                                <div className="space-y-1">
                                    <div className="bg-blue-500 rounded-2xl rounded-br-md px-4 py-3 shadow-sm">
                                        <p className="text-white">
                                            Pretty good! Just finished a big
                                            project. How about you?
                                        </p>
                                    </div>
                                    <p className="text-xs text-gray-500 mr-3 text-right">
                                        2:32 PM
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-end">
                            <div className="flex max-w-xs lg:max-w-md flex-row-reverse">
                                <div className="space-y-1">
                                    <div className="bg-blue-500 rounded-2xl rounded-br-md px-4 py-3 shadow-sm">
                                        <p className="text-white">
                                            Perfect! Let's meet at the coffee
                                            shop
                                        </p>
                                    </div>
                                    <div className="bg-blue-500 rounded-2xl rounded-br-md px-4 py-3 shadow-sm">
